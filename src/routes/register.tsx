...
function RouteComponent() {
  ...
  return (
    <article className="w-full max-w-md bg-white/90 backdrop-blur-md px-8 pt-12 pb-8 rounded-2xl shadow-2xl border border-white/50 relative z-10">
      ...
      <footer className="mt-5 text-center text-xs leading-5 text-slate-500">
        Find a QR marker after each riddle. Every marker reveals a clue for your
        current quest.
      </footer>
    </article>
  );
